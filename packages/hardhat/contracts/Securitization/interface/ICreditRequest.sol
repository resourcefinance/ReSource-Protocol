...
interface ICreditRequest {
    ...
    function updateRequestLimit(address _network, address _counterparty, uint256 _creditLimit) external;
    ...
    function calculateRequestCollateral(address _network, address _counterparty) external returns(uint256);
