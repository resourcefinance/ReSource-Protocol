...
interface CreditPoolStakeableInterface extends ethers.utils.Interface {
  functions: {
...
export class CreditPoolStakeable extends BaseContract {
  ...
  interface: CreditPoolStakeableInterface;
