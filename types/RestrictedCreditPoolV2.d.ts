...
interface RestrictedCreditPoolV2Interface extends ethers.utils.Interface {
  functions: {
...
export class RestrictedCreditPoolV2 extends BaseContract {
  ...
  interface: RestrictedCreditPoolV2Interface;
